...
abstract class RecipeListModule {
    ...
    @Binds
    abstract fun view(view: RecipeListActivity): RecipeListFacade.View
    ...
    companion object {
        @JvmStatic
        @Provides
        fun adapter(recipeListListener: RecipeListFacade.RecipeListListener) = RecipeListAdapter(recipeListListener)
    }
}
